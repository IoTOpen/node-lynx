...
export function GetStatus(installationId: number, topicFilter?: string[]) {
...
export function GetLog (installationId: number, from?: number, to?: number, limit = 500, offset = 0, order = LogOrder.Desc, topics?: string[]) {
